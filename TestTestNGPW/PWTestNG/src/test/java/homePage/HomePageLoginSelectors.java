...
public class HomePageLoginSelectors {
	...
	public static void main(String[] args) {
		...
		//page.navigate("https://ibeuat.flynas.com/MobilePreLive/#/booking/search"); //MobPreLive
		page.navigate("https://booking.flynas.com/#/booking/search"); //Live
		 ...
		 page.type("//span[normalize-space()='From']", "RUH"); //Departure
		 page.keyboard().press("Enter");
		 page.type("//span[normalize-space()='To']", "JED");  //Arrival
		 page.keyboard().press("Enter");
